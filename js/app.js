const plants = [
  ...
  },
  {
    ...
    girl: {
      title: "巻き毛の山里娘 ゼンマイ",
      catchcopy: "急がないで。ほどけるには、山の時間がいるの。",
      description: [
        "落ち葉の積もる林の奥で、くるくる巻いた髪をふわりと揺らす山菜少女。眠たげな目で静かに笑い、春の山里にゆっくり姿を現す。",
        "口数は少ないが、手間をかけることを大切にしている。摘んで、ゆでて、揉んで、干して、戻して食べるまでの時間を、面倒ではなく山の贈り物だと思っている。",
        "料理では煮物や炒め煮が好き。派手な主役ではないけれど、噛むほどに山里の記憶がほどけるような、しみじみした味わいを誇りにしている。"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    girl: {
      title: "棘衣の山菜王 タラの芽",
      catchcopy: "我こそ春山の王。天ぷらの座は譲らぬ。",
      description: [
        "険しい山肌を見下ろすように立つ、誇り高い山菜少女。棘を思わせる衣をまとい、腕を組んで堂々と構える姿は、まさに春山の王と呼ぶにふさわしい。",
        "自信家で少し尊大だが、味への誇りは本物。自分が天ぷらにされた時の香りとほろ苦さを誰よりも理解していて、雑な扱いをされると静かに眉をひそめる。",
        "採りすぎには厳しく、若芽をすべて奪う者には容赦がない。王らしく威張ってはいるが、山を守るための筋はしっかり通す、気高い春の番人。"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    girl: {
      title: "沢音の釣り娘 ミズ",
      catchcopy: "静かにしてね。沢の音と、山の気配を聞いてるの。",
      description: [
        "冷たい沢水のそばで釣り竿を片手に振り返る、涼やかな山菜少女。水しぶきの中でも落ち着いていて、湿った岩場や谷筋を軽やかに歩く。",
        "控えめで穏やかだが、山の音を聞き分ける感覚は鋭い。賑やかな場所より、沢の音が響く静かな場所を好み、仲良くなると採りごろの場所をそっと教えてくれる。",
        "料理ではおひたしや味噌汁が好き。派手な味ではないけれど、シャキッとした歯ざわりとやさしいぬめりで、食卓に涼しい余韻を残す。"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    girl: {
      title: "あぜ道の駆けっこ娘 ノビル",
      catchcopy: "見つけた？じゃあ競争ね！あぜ道の端まで、よーいどん！",
      description: [
        "田んぼのあぜや春の土手を、泥だらけの足で軽やかに走り回る山菜少女。小さな白い球根を髪飾りのように揺らし、明るい笑顔で野の春を連れてくる。",
        "人なつっこくて落ち着きがなく、見つけてもらうとすぐに遊びに誘ってくる。けれど香りにはちょっと自信があり、料理に入ると小さい体でもきりっと存在感を出す。",
        "酢味噌和えや天ぷらが好き。しゃれた料理より、外でたくさん遊んだあとに食べる素朴な一皿をいちばん誇らしく思っている。"
      ]
    }
  },
  {
    ...
    girl: {
      title: "橙花の野原姫 カンゾウ",
      catchcopy: "急がなくていいの。花も若芽も、季節を待てばちゃんと開くわ。",
      description: [
        "春の野原でやわらかな若芽をまとい、夏には橙の花を髪に咲かせる山菜少女。明るい日差しの中に立つ姿は華やかだが、話し方はゆったりとしていて落ち着いている。",
        "控えめに微笑む姫君気質で、せかされるのが少し苦手。けれど季節の移ろいをよく知っていて、若芽のころ、つぼみのころ、それぞれの良さを静かに教えてくれる。",
        "料理では酢味噌和えや天ぷらが好き。派手な香りではないが、やさしい甘みとやわらかな食感で、春の食卓をふっと穏やかにしてくれる。"
      ]
    }
  },
  {
    ...
    girl: {
      title: "酸っぱ元気な川辺娘 イタドリ",
      catchcopy: "ぽきっと折って、かじってみる？すっぱい顔、見せてよ！",
      description: [
        "川辺や土手で太陽を浴びながら、赤い節の茎を片手ににかっと笑う山菜少女。じっとしているのが苦手で、気づけば誰かに勝負をしかけたり、酸っぱい茎をすすめたりしている。",
        "陽気で人懐っこいが、少し悪戯好き。相手が酸っぱさに驚く顔を見るのが好きで、本人はそれを春の挨拶くらいに思っている。",
        "料理では炒め物や塩漬けが好き。きゅっとした酸味を抜きすぎると少し不満げだが、上手に仕上がると誰よりも元気よく食卓を盛り上げる。"
      ]
    }
  },
  {
    ...
    girl: {
      title: "水辺に絡まるクレソン姫",
      catchcopy: "あ、待って……髪がまた流れにほどけちゃう。",
      description: [
        "清い流れのほとりで、長い髪と白い小花を水面に揺らす山菜少女。涼しげな見た目とは裏腹に、少し困り顔で、気づけば髪や蔓があちこちに絡まっている。",
        "おとなしく繊細だが、口にするとぴりっと辛口。遠慮がちな声で核心を突くことがあり、本人はその鋭さにあまり自覚がない。",
        "料理ではサラダや肉料理の付け合わせが好き。澄んだ水の香りとさわやかな辛みで、重たい料理にもすっと風を通してくれる。"
      ]
    }
  },
  {
