const plants = [
  ...
  },
  {
    ...
    girl: {
      title: "棘纏いの荒姫 ハリギリ",
      catchcopy: "ウチだって山菜だろ……？ なんで、あいつらばっかり……",
      description: [
        "スラっとしたスタイルに、非常に美しい顔立ち。ビジュアルは良いのに、全く似合わない服を着ているのは、半グレだから。",
        "相手側は全く気にも留めていないが、彼女にとってはタラの芽とコシアブラをとんでもなく意識しており、コンプレックスからグレている。二人の名を出すとブチ切れて、棘で刺そうとしてくるが、「下位互換」などと言われると、本気で泣いてしまう。",
        "なまじ「山菜」として張り合おうとするから悲しい事になるだけで、本当は別の魅力を持っている。もっと成長したあと、別の役割と誇りを見つけるのは、今の彼女はまだ知らない。"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    girl: {
      title: "清流の隠居娘 わさび",
      catchcopy: "、、、近寄らないでください。",
      description: [
        "山奥にひっそり、隠れるように暮らしている引きこもりの山菜娘。極度の人見知りと懐かない性格で、常にツンツンしている。",
        "甘い物やあたたかいものを与えて釣ろうとすると、さらに拒絶し、余計にツンツンしてしまう。つまり「デレ」の無い、完全な「ツン」属性。",
        "だが、そのツンが癖になると、彼女の刺激にハマってしまう者も多いという。"
      ]
    }
  },
  {
